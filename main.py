...
async def obtener_marcadores():
    return {
        "marcadores": [
            ...
            # Champions League
            {"nombre": "Ajax", "ciudad": "Ámsterdam", "estadio": "Johan Cruyff Arena", "lat": 52.3140, "lng": 4.9410, "fundacion": 1900, "titulos_liga": 36, "liga": "Champions League", "pais": "NED"},
            ...
            {"nombre": "Atalanta", "ciudad": "Bérgamo", "estadio": "Gewiss Stadium", "lat": 45.7089, "lng": 9.6866, "fundacion": 1907, "titulos_liga": 0, "liga": "Champions League", "pais": "ITA"},
            {"nombre": "Athletic Club", "ciudad": "Bilbao", "estadio": "San Mamés", "lat": 43.2641, "lng": -2.9501, "fundacion": 1898, "titulos_liga": 8, "liga": "Champions League", "pais": "ESP"},
            {"nombre": "Atletico Madrid", "ciudad": "Madrid", "estadio": "Cívitas Metropolitano", "lat": 40.4361, "lng": -3.5994, "fundacion": 1903, "titulos_liga": 11, "liga": "Champions League", "pais": "ESP"},
            ...
            {"nombre": "Bayern München", "ciudad": "Múnich", "estadio": "Allianz Arena", "lat": 48.2188, "lng": 11.6248, "fundacion": 1900, "titulos_liga": 33, "liga": "Champions League", "pais": "GER"},
            {"nombre": "Benfica", "ciudad": "Lisboa", "estadio": "Estádio da Luz", "lat": 38.7527, "lng": -9.1848, "fundacion": 1904, "titulos_liga": 38, "liga": "Champions League", "pais": "POR"},
            {"nombre": "Bodø/Glimt", "ciudad": "Bodø", "estadio": "Aspmyra Stadion", "lat": 67.2890, "lng": 14.4040, "fundacion": 1916, "titulos_liga": 2, "liga": "Champions League", "pais": "NOR"},
            {"nombre": "Chelsea", "ciudad": "Londres", "estadio": "Stamford Bridge", "lat": 51.4817, "lng": -0.1910, "fundacion": 1905, "titulos_liga": 6, "liga": "Champions League", "pais": "ENG"},
            {"nombre": "Club Brugge", "ciudad": "Brujas", "estadio": "Jan Breydel Stadium", "lat": 51.1868, "lng": 3.1710, "fundacion": 1891, "titulos_liga": 18, "liga": "Champions League", "pais": "BEL"},
            {"nombre": "Copenhagen", "ciudad": "Copenhague", "estadio": "Parken Stadium", "lat": 55.7026, "lng": 12.5720, "fundacion": 1992, "titulos_liga": 15, "liga": "Champions League", "pais": "DEN"},
            {"nombre": "Eintracht Frankfurt", "ciudad": "Fráncfort", "estadio": "Deutsche Bank Park", "lat": 50.0687, "lng": 8.6450, "fundacion": 1899, "titulos_liga": 1, "liga": "Champions League", "pais": "GER"},
            {"nombre": "Galatasaray", "ciudad": "Estambul", "estadio": "Rams Park", "lat": 41.1032, "lng": 29.0119, "fundacion": 1905, "titulos_liga": 23, "liga": "Champions League", "pais": "TUR"},
            {"nombre": "Inter", "ciudad": "Milán", "estadio": "San Siro", "lat": 45.4781, "lng": 9.1240, "fundacion": 1908, "titulos_liga": 20, "liga": "Champions League", "pais": "ITA"},
            {"nombre": "Juventus", "ciudad": "Turín", "estadio": "Allianz Stadium", "lat": 45.1096, "lng": 7.6413, "fundacion": 1897, "titulos_liga": 36, "liga": "Champions League", "pais": "ITA"},
            {"nombre": "Kairat Almaty", "ciudad": "Almatý", "estadio": "Almaty Central Stadium", "lat": 43.2458, "lng": 76.9157, "fundacion": 1954, "titulos_liga": 3, "liga": "Champions League", "pais": "KAZ"},
            {"nombre": "Leverkusen", "ciudad": "Leverkusen", "estadio": "BayArena", "lat": 51.0383, "lng": 7.0022, "fundacion": 1904, "titulos_liga": 1, "liga": "Champions League", "pais": "GER"},
            {"nombre": "Liverpool", "ciudad": "Liverpool", "estadio": "Anfield", "lat": 53.4308, "lng": -2.9608, "fundacion": 1892, "titulos_liga": 19, "liga": "Champions League", "pais": "ENG"},
            ...
            {"nombre": "Marseille", "ciudad": "Marsella", "estadio": "Stade Vélodrome", "lat": 43.2696, "lng": 5.3956, "fundacion": 1899, "titulos_liga": 9, "liga": "Champions League", "pais": "FRA"},
            {"nombre": "Monaco", "ciudad": "Mónaco", "estadio": "Stade Louis II", "lat": 43.7277, "lng": 7.4167, "fundacion": 1924, "titulos_liga": 8, "liga": "Champions League", "pais": "MON"},
            {"nombre": "Napoli", "ciudad": "Nápoles", "estadio": "Stadio Diego Armando Maradona", "lat": 40.8279, "lng": 14.1931, "fundacion": 1926, "titulos_liga": 3, "liga": "Champions League", "pais": "ITA"},
            {"nombre": "Newcastle", "ciudad": "Newcastle", "estadio": "St James' Park", "lat": 54.9756, "lng": -1.6217, "fundacion": 1892, "titulos_liga": 4, "liga": "Champions League", "pais": "ENG"},
            {"nombre": "Olympiacos", "ciudad": "El Pireo", "estadio": "Karaiskakis Stadium", "lat": 37.9428, "lng": 23.6645, "fundacion": 1925, "titulos_liga": 47, "liga": "Champions League", "pais": "GRE"},
            {"nombre": "Pafos", "ciudad": "Pafos", "estadio": "Stelios Kyriakides Stadium", "lat": 34.7757, "lng": 32.4291, "fundacion": 2014, "titulos_liga": 0, "liga": "Champions League", "pais": "CYP"},
            {"nombre": "Paris", "ciudad": "París", "estadio": "Parc des Princes", "lat": 48.8414, "lng": 2.2530, "fundacion": 1970, "titulos_liga": 11, "liga": "Champions League", "pais": "FRA"},
            {"nombre": "PSV", "ciudad": "Eindhoven", "estadio": "Philips Stadion", "lat": 51.4419, "lng": 5.4671, "fundacion": 1913, "titulos_liga": 25, "liga": "Champions League", "pais": "NED"},
            {"nombre": "Qarabağ", "ciudad": "Bakú", "estadio": "Azersun Arena", "lat": 40.4118, "lng": 49.9143, "fundacion": 1951, "titulos_liga": 10, "liga": "Champions League", "pais": "AZE"},
            {"nombre": "Real Madrid", "ciudad": "Madrid", "estadio": "Santiago Bernabéu", "lat": 40.4530, "lng": -3.6883, "fundacion": 1902, "titulos_liga": 35, "liga": "Champions League", "pais": "ESP"},
            {"nombre": "Slavia Praha", "ciudad": "Praga", "estadio": "Fortuna Arena", "lat": 50.0670, "lng": 14.4656, "fundacion": 1892, "titulos_liga": 21, "liga": "Champions League", "pais": "CZE"},
            {"nombre": "Sporting CP", "ciudad": "Lisboa", "estadio": "Estádio José Alvalade", "lat": 38.7612, "lng": -9.1604, "fundacion": 1906, "titulos_liga": 20, "liga": "Champions League", "pais": "POR"},
            {"nombre": "Tottenham", "ciudad": "Londres", "estadio": "Tottenham Hotspur Stadium", "lat": 51.6033, "lng": -0.0658, "fundacion": 1882, "titulos_liga": 2, "liga": "Champions League", "pais": "ENG"},
            {"nombre": "Union SG", "ciudad": "Bruselas", "estadio": "Stade Joseph Marien", "lat": 50.8157, "lng": 4.3297, "fundacion": 1897, "titulos_liga": 11, "liga": "Champions League", "pais": "BEL"},
